...
| 融資餘額 | Margin Balance | 整體市場未償還的融資金額，視為槓桿買進意願指標 | → 融資、→ 維持率 | **v1.1 對位**:§5 #5 散戶情緒觀測 3 元件之一(融資餘額/融資維持率/當沖佔比),屬寬鬆觀測,非 §3 權威判別 |
...
| 美元指數 | DXY（U.S. Dollar Index） | 美元對一籃子主要貨幣的綜合強度指數 | → 新台幣匯率、→ 新興市場資金流 | **v1.1 對位**:§5 #1 美台資金開關觀測 4 元件之一(US10Y/DXY/USD-JPY/台灣壓力指數),屬寬鬆觀測,非 §3 權威判別 |
